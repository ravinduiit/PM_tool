...
<script>
        ...
        // Sample variable for projects data
    const projects = [
        { title: "GYM Project", completion: 80 },
        { title: "Fitness Tracker", completion: 60 },
        { title: "Yoga Class App", completion: 45 },
        { title: "Health Blog", completion: 90 },
        { title: "Nutrition Plan", completion: 75 },
        { title: "Workout Planner", completion: 50 },
        { title: "Meditation App", completion: 30 },
        { title: "Cricket App", completion: 80 }
    ];
    ...
    projects.forEach((project, index) => {
        // Get the color based on the index (cycle after 5)
                ...
                <div class="card text-white ${cardColor}">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            <h3>Done</h3>
                            <h2 class="text-white mb-0 ms-2">${project.completion}%</h2>
                        </div>
